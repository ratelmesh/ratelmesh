...
ARCHIVE_PATH=$1
"$ROOT/Scripts/verify-archive.sh" "$ARCHIVE_PATH"

UPLOAD_OPTIONS=$(mktemp "${TMPDIR:-/tmp}/ratelmesh-ios-upload-options.XXXXXX")
...
xcodebuild -allowProvisioningUpdates \
    ...
    -exportPath "${TMPDIR:-/tmp}/ratelmesh-ios-upload" \
